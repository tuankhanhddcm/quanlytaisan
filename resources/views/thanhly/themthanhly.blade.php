...
<div class="col-sm-12" style="min-height: 665px; background-color: white;">
    <div class="main_ward">
        ...
        <form action="{{route('thanhly.store')}}"  onsubmit="return check_inser_thanhly()" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- @php
            if(isset($bangiao)){
                $phonggiao ='';
            ...
            <div class="col-sm-12 row">
                <div class="col-sm-6">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="form-wrap">
                            <div class="form_input">
                                <input type="text" class="form-input  nguoimua" name="nguoimua" onchange="check('.nguoimua_lb')" value="{{isset($bangiao)?$bangiao->:''}}"  placeholder="dd-mm-yyyy">
                            </div>
                            <div style="display: flex;">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="form-wrap">
                            <div class="form_input">
                                <input type="text" class="form-input date ngaylap" name="ngaylap" onchange="check('.ngaylap_lb')" value="{{isset($bangiao)?date('m-d-Y',strtotime($bangiao->ngay_nhan)):''}}"  placeholder="dd-mm-yyyy">
                            </div>
                            <div style="display: flex;">
