        ...
        @foreach ($ncc as $key => $item)
            <tr class="body-table">
                ...
                <td >
                    ...
                    <button class="btn_delete_ncc" data-id="{{$item->ma_ncc}}" style="width:40px; height:40px; margin-left: 10%; border:none; background-color: transparent;" ><i class='bx bxs-x-square' style="font-size: 30px; color:#FF3300;"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
