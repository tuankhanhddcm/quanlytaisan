        ...
        @foreach ($phongban as $key => $item)
            <tr>
                ...
                <td style="display: flex;justify-content: center">
                    ...
                    <button class="btn_delete_phong" data-id="{{$item->ma_phong}}" style="width:40px; height:40px; margin-left: 10%; border:none; background-color: transparent;" ><i class='bx bxs-x-square' style="font-size: 30px; color:#FF3300;"></i></button>
                </td>
            </tr>
        @endforeach
    </tbody>
